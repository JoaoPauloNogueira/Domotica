package com.example.joaopaulo.domoticaapp.bluetooth;
...
public class BluetoothService {
    ...
    private static final UUID MY_UUID_ARDUINO = UUID.fromString("00001101-0000-1000-8000-00805f9b34fb");
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, "Não foi possível se conectar ao dispositivo.");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, "Conexão com o dispositivo perdida.");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                tmp = device.createInsecureRfcommSocketToServiceRecord(MY_UUID_ARDUINO);
